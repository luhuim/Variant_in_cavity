...
#write a loop to get the sum of colum 
...
# res <- t.test(sum_cavity_amino_acid_1, sum_all_amino_acid, paired = TRUE)
# res
...
for (i in 1:20)
{
  x<-sum_cavity_amino_acid_1[i]/sum(sum_cavity_amino_acid_1)
  x
  #sum(sum_cavity_amino_acid_1)
